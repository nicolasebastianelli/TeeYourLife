...
xmlhttp1.open("GET","loadshopallproducts.php",true);
xmlhttp1.send();
}
...
xmlhttp2.open("GET","loadshopcollection.php",true);
xmlhttp2.send();
}
...
xmlhttp1.open("GET","loadshopproductscollection.php?coll="+str,true);
xmlhttp1.send();
}
...
xmlhttp1.open("GET","loadshopproductssearch.php?search="+str,true);
xmlhttp1.send();
}
   ...
   <div class="clearfix grpelem" id="ppmenuu344"><!-- column -->
    ...
    <div class="clearfix colelem" id="pu5559"><!-- group -->
     ...
     <div class="clearfix grpelem" id="pu4781">
      <div class="colelem" >
      <form method="get" action="shop.php" id="search" >
