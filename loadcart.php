<?php
    session_start();
      ...
      echo"</div>";
      echo"</a>"; 
      echo"<a href='removeproduct.php?codpro=".$codpro."'>";
      echo" <div class='clearfix grpelem'  id='u6047-4'><!-- content -->";
      echo"  <p id='u6048-3'><span style='font-weight: bold;' id='u6048'><font size='4'>×</font></span><span id='u6048-2'>Remove product</span></p>";
      echo" </div>";
      echo"</a>";     
