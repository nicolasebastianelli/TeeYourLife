...
window.location.href ="changeqtcart.php?codpro="+str1+"&qt="+str2.value;
}
</script>
<script>
function loadcart()
    ...
    <div class="clearfix colelem" id="pu6037"><!-- group -->
     ...
     <div class="rounded-corners clearfix grpelem" id="u6038"><!-- column -->
      <div class="clearfix colelem" id="u6039-4"><!-- content -->
       <p>Provisional total (<?php echo($ncart);?> product):</p>
      </div>
...
Muse.Utils.transformMarkupToFixBrowserProblems();/* body */
 ...
 <script type="text/javascript">
        ...
        function empty() {
			reset();
			alertify.error("Cart empty");
			return false;
		}
		function remove() {
			reset();
			alertify.success("Product successfully removed from cart");
			return false;
		}
