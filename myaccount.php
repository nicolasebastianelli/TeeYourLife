  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
      ...
      <li class="MenuItemContainer clearfix grpelem" id="u5313"><!-- vertical box -->
       <div class="MenuItem MenuItemWithSubMenu clearfix colelem" id="u5314"><!-- horizontal box -->
        <div class="MenuItemLabel NoWrap clearfix grpelem" id="u5316-6"><!-- content -->
         <p id="u5316-4"><span id="u5316">&nbsp; </span><span id="u5316-2">Hi.</span><?php if(!isset($_SESSION['mail']) || empty($_SESSION['mail'])){echo"<span id='u5316-3'>SignIn</span>";} else{echo "<span id='u5316-3'>".$_SESSION['name']."</span>";} ?></p>
        </div>
    ...
    <div class="rgba-background rounded-corners clearfix colelem" id="u6102"><!-- group -->
     <img class="grpelem" id="u6121-4" src="images/u6121-4.png" alt="My Account" width="352" height="57"/><!-- rasterized frame -->
    </div>
    <img class="colelem" id="u6174-4" src="images/u6174-4.png" alt="Change your infos" width="1017" height="57"/><!-- rasterized frame -->
    <div class="clearfix colelem" id="pu6146"><!-- group -->
     <div class="clearfix grpelem" id="u6146"><!-- column -->
      <div class="position_content" id="u6146_position_content">
       ...
       <form name="fname" action="updateip.php" method = "POST" >
     ...
     <div class="clearfix grpelem" id="u6179"><!-- column -->
      <div class="position_content" id="u6179_position_content">
       ...
       <form name="fsurname" action="updateip.php" method = "POST" >
     ...
     <div class="clearfix grpelem" id="u6185"><!-- column -->
      <div class="position_content" id="u6185_position_content">
       ...
       <form name="fcap" action="updateip.php" method = "POST" >
    ...
    <div class="clearfix colelem" id="pu6209"><!-- group -->
     <div class="clearfix grpelem" id="u6209"><!-- column -->
      <div class="position_content" id="u6209_position_content">
       ...
       <form name="fcity" action="updateip.php" method = "POST" >
     ...
     <div class="clearfix grpelem" id="u6215"><!-- column -->
      <div class="position_content" id="u6215_position_content">
       ...
       <form name="faddress" action="updateip.php" method = "POST" >
     ...
     <div class="clearfix grpelem" id="u6221"><!-- column -->
      <div class="position_content" id="u6221_position_content">
       ...
       <form name="fpass" action="updateip.php" method = "POST" >
...
<script type="text/javascript">
		...
		function empty() {
		reset();
			alertify.error("Value not setted");
			return false;
		}
		function nameupdate(){
		reset();
			alertify.success("Name update successfully");
			return false;
			}
		function surnameupdate(){
		reset();
			alertify.success("Surname update successfully");
			return false;
		}
				function capupdate(){
		reset();
			alertify.success("CAP update successfully");
			return false;
		}
				function cityupdate(){
		reset();
			alertify.success("City update successfully");
			return false;
		}
