...
xmlhttp.open("GET","loadcheckout.php",true);
xmlhttp.send();
}
</script>
    ...
    <div class="clearfix colelem" id="pmenuu344"><!-- group -->
     <ul class="MenuBar clearfix grpelem" id="menuu344"><!-- horizontal box -->
      <li class="MenuItemContainer clearfix grpelem" id="u1201"><!-- vertical box -->
       <a class="nonblock nontext MenuItem MenuItemWithSubMenu gradient rounded-corners clearfix colelem" id="u1202" href="index.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1204-4"><!-- content --><p>HOME</p></div></a>
      </li>
    ...
    <div class="clearfix colelem" id="pu6198"><!-- group -->
     ...
     <div class="rounded-corners clearfix grpelem" id="u6102"><!-- column -->
      <div class="clearfix colelem" id="u6103-4"><!-- content -->
       <p>Total (<?php echo($ncart);?> product):</p>
      </div>
...
<script type="text/javascript">
		function reset () {
			...
			alertify.confirm("You are going to carry out the order, confirm?", function (e) {
				if (e) {
					window.location='order.php';
				} else {
					alertify.error("Order not confirm");
				}
			});
			return false;
		});
