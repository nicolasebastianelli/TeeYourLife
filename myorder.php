...
<html class="html">
 <head>
  ...
  <title>TYL : MY ORDER</title>
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="css/site_global.css?4071467339"/>
  <link rel="stylesheet" type="text/css" href="css/master_en.css?4129122692"/>
  <link rel="stylesheet" type="text/css" href="css/my-order.css?4289523449" id="pagesheet"/>
  <!-- Other scripts -->
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("u6270").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","loadorder.php",true);
xmlhttp.send();
}
</script>
   </head>
 ...
 <script>loadorder()</script>
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class="rgba-background rounded-corners clearfix colelem" id="u6244"><!-- group -->
     <img class="grpelem" id="u6269-4" src="images/u6269-4.png" alt="My Order" width="352" height="57" style="left: 335px; top: 2px"/><!-- rasterized frame -->
    </div>
    <div class="clearfix colelem" id="pu6270"><!-- group -->
     <div class="clearfix grpelem" id="u6270" style="left: 0px; top: 0px"><!-- group -->
