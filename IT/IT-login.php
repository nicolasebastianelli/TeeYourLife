   ...
   <div class="clearfix grpelem" id="pmenuu344"><!-- group -->
    <ul class="MenuBar clearfix grpelem" id="menuu344"><!-- horizontal box -->
     <li class="MenuItemContainer clearfix grpelem" id="u1201"><!-- vertical box -->
      <a class="nonblock nontext MenuItem MenuItemWithSubMenu clearfix colelem MuseMenuActive" id="u1202" href="IT-index.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1204-4"><!-- content --><p>HOME</p></div></a>
     </li>
...
<!--LOGIN FORM-->
<form name="login-form" class="login-form" action="IT-controllogin.php" method="post" id="lean_overlay">

	<!--HEADER-->
    <div class="header">
    <center><!--TITLE--><h1>Accedi</h1><!--END TITLE--></center>
    </div>
    <!--END HEADER-->
	<br>
	<br>
    ...
    <!--FOOTER-->
    <div class="footer">
    <!--LOGIN BUTTON--><input type="submit" name="submit" value="Accedi" class="button" ><!--END LOGIN BUTTON-->
    <a href="IT-register.php"><!--REGISTER BUTTON--><input type="button" name="submit" value="Registrati" class="register" ></a>
    <!--END REGISTER BUTTON-->
    </div>
    <!--END FOOTER-->
...
<script type="text/javascript">
      ...
      function errore() {
			reset();
			alertify.error("Errore: E-mail o Password sbagliata");
			return false;
		}
		</script>
