...
xmlhttp.open("GET","IT-loadorder.php",true);
xmlhttp.send();
}
</script>
   </head>
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class="rgba-background rounded-corners clearfix colelem" id="u6244"><!-- group -->
     <img class="grpelem" id="u6269-4" src="../images/u6269-5.png" alt="My Order" width="352" height="57" /><!-- rasterized frame -->
    </div>
