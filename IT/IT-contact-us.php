  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="pmenuu344"><!-- group -->
     <ul class="MenuBar clearfix grpelem" id="menuu344"><!-- horizontal box -->
      ...
      <li class="MenuItemContainer clearfix grpelem" id="u1215"><!-- vertical box -->
       <a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive clearfix colelem" id="u1218" href="IT-contact-us.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1221-4"><!-- content --><p>CONTATTACI</p></div></a>
      </li>
    ...
    <div class="rgba-background rounded-corners clearfix colelem" id="u1452"><!-- group -->
     <img class="grpelem" id="u1014-4" src="../images/u1014-5.png" alt="Tell us something beautiful" width="811" height="57"/><!-- rasterized frame -->
    </div>
    <div class="clearfix colelem" id="pu1438-4"><!-- group -->
     <div class="clearfix grpelem" id="u1438-4"><!-- content -->
     <center>
      <p>IL TUO FEEDBACK E' IMPORTANTE:</p>
      </center>
     </div>
    ...
    <form class="form-grp clearfix colelem" id="u539" method="post" enctype="multipart/form-data" action="IT-asktous.php"><!-- none box -->
     <div class="fld-grp clearfix grpelem" id="widgetu551" data-required="true"><!-- none box -->
      <label class="fld-label actAsDiv clearfix grpelem" id="u553-4" for="widgetu551_input"><!-- content -->
       <span class="actAsPara">Nome:</span>
      </label>
      <span class="fld-input NoWrap actAsDiv clearfix grpelem" id="u555-4"><!-- content --><input class="wrapped-input" placeholder="Inserisci Il Tuo Nome" type="text" spellcheck="false" id="widgetu551_input" name="name" tabindex="2"/></span>
     </div>
     <div class="fld-grp clearfix grpelem" id="widgetu541" data-required="true" data-type="email"><!-- none box -->
      ...
      <span class="fld-input NoWrap actAsDiv clearfix grpelem" id="u542-4"><!-- content --><input class="wrapped-input" type="text" placeholder="Inserisci La Tua Mail" spellcheck="false" id="widgetu541_input" name="mail" tabindex="3"/></span>
     </div>
     ...
     <div class="fld-grp clearfix grpelem" id="widgetu546" data-required="false"><!-- none box -->
      <label class="fld-label actAsDiv clearfix grpelem" id="u549-4" for="widgetu546_input"><!-- content -->
       <span class="actAsPara">Messaggio:</span>
      </label>
      <span class="fld-textarea actAsDiv clearfix grpelem" id="u547-4"><!-- content --><textarea class="wrapped-input" placeholder="Inserisci Il Tuo Messaggio" id="widgetu546_input" name="message" tabindex="4"></textarea></span>
     </div>
     <div class="fld-grp clearfix grpelem" id="widgetu751" data-required="true"><!-- none box -->
      <label class="fld-label actAsDiv clearfix grpelem" id="u752-4" for="widgetu751_input"><!-- content -->
       <span class="actAsPara">Cognome:</span>
      </label>
      <span class="fld-input NoWrap actAsDiv clearfix grpelem" id="u753-4"><!-- content --><input class="wrapped-input" placeholder="Inserisci Il Tuo Cognome" type="text" id="widgetu751_input" name="surname" tabindex="1"/></span>
     </div>
    </form>
    <div class="clearfix colelem" id="pu1446-7"><!-- group -->
     <div class="clearfix grpelem" id="u1446-7"><!-- content -->
      <p id="u1446-2">Chiamaci al: 333&#45;272&#45;8894</p>
...
<script type="text/javascript">
		function reset () {
            ...
            function empty() {
			reset();
			alertify.error("Inserisci tutti i campi");
			return false;
		}
		function send() {
			reset();
			alertify.success("Messaggio Inviato con successo ");
			return false;
		}
