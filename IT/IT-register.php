...
$(document).ready(function() {
 ...
 <body>
  ...
  <div class="clearfix" id="page"><!-- group -->
   ...
   <div id='wrap'>
		<section class='form'>
			<form action="IT-controlregister.php" method="post" >
				<fieldset>
					<div class="item">
						<label>
							<span style="width: 205px">Nome:</span>
							<input  data-validate-length-range="6" data-validate-words="2" name="name" required="" tabindex="1" placeholder="ex. Mario"  />		
						</label>
					</div>
					<div class="item">
						<label>
							<span style="width: 205px">Cognome:</span>
							<input name="surname" required="" tabindex="1" data-validate-words="2" placeholder="ex. Rossi" />
						</label>
					</div>
					<div class="item">
						<label>
							<span style="width: 205px">email:</span>
							<input name="email" class='email' tabindex="1"required="required" placeholder="ex. e-mail@esempio.com"type="email" />
						</label>
					</div>
					<div class="item">
						<label>
							<span style="width: 205px">Nato il: (Almeno 14 anni)</span>
					...
					<div class="item">
						<label>
							<span style="width: 205px">Password: (almeno 8 caratteri)</span>&nbsp;<input type="password" tabindex="1"name="password" id="password" data-validate-length="6,8" required='required'>
						</label>
					</div>
					<div class="item">
						<label>
							<span style="width: 205px">Ripeti password:</span>
					...
					<div class="item">
						<label>
							<span style="width: 205px">nazione:</span>
...
<option value="Zaire">Zaire</option>
                  <option value="Zambia">Zambia</option>
					...
					<div class="item">
						<label>
							<span style="width: 205px">città:</span>
							<input name="city" placeholder="ex. Milano" required tabindex="1" />
						</label>
					</div>
					<div class="item">
						<label>
							<span style="width: 205px">Indirizzo:</span>
							<input name="address"  placeholder="ex. Via Esempio 00" required tabindex="1"/>
						</label>
					</div>
				</fieldset>
				 <input class="buttom" name="submit" id="submit" value="Invia" type="submit" style="width: 117px; height: 29px">
			</form>	
		</section>
	</div>
...
<script type="text/javascript">
      ...
      function errore1() {
		...
		function errore2() {
			reset();
			alertify.error("Questa e-mail già esiste");
			return false;
		}
		function lengtherr(){
		reset();
			alertify.error("La password deve essere almeno 8 caratteri");
			return false;
		}
