...
<html class="html">
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/checkout.css?3994141471" id="pagesheet"/>
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("u6153").innerHTML=xmlhttp.responseText;
    }
  }
xmlhttp.open("GET","IT-loadcheckout.php",true);
xmlhttp.send();
}
</script>
 ...
 <script>loadcheck()</script>
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="pmenuu344"><!-- group -->
     <ul class="MenuBar clearfix grpelem" id="menuu344"><!-- horizontal box -->
      <li class="MenuItemContainer clearfix grpelem" id="u1201"><!-- vertical box -->
       <a class="nonblock nontext MenuItem MenuItemWithSubMenu gradient rounded-corners clearfix colelem" id="u1202" href="IT-index.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1204-4"><!-- content --><p>HOME</p></div></a>
      </li>
      <li class="MenuItemContainer clearfix grpelem" id="u2294"><!-- vertical box -->
       <a class="nonblock nontext MenuItem MenuItemWithSubMenu gradient rounded-corners clearfix colelem" id="u2295" href="IT-shop.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u2296-4"><!-- content --><p>SHOP</p></div></a>
      </li>
      <li class="MenuItemContainer clearfix grpelem" id="u1215"><!-- vertical box -->
       <a class="nonblock nontext MenuItem MenuItemWithSubMenu gradient rounded-corners clearfix colelem" id="u1218" href="IT-contact-us.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1221-4"><!-- content --><p>CONTATTACI</p></div></a>
      </li>
      <li class="MenuItemContainer clearfix grpelem" id="u1222"><!-- vertical box -->
       <a class="nonblock nontext MenuItem MenuItemWithSubMenu gradient rounded-corners clearfix colelem" id="u1223" href="IT-about-us.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1225-4"><!-- content --><p>CHI SIAMO</p></div></a>
      </li>
     </ul>
     ...
     <div class="museBGSize grpelem" id="u1132"><!-- simple frame --></div>
     ...
     <ul class="MenuBar clearfix grpelem" id="menuu5257"><!-- horizontal box -->
      ...
      <li class="MenuItemContainer clearfix grpelem" id="u5320"><!-- vertical box -->
       <div class="MenuItem MenuItemWithSubMenu gradient clearfix colelem MuseMenuActive" id="u5321"><!-- horizontal box -->
    ...
    <div class="clearfix colelem" id="pu6198"><!-- group -->
     <div class="rounded-corners clearfix grpelem" id="u6198"><!-- group -->
      <div class="rounded-corners clearfix grpelem" id="u6199"><!-- column -->
       <div class="position_content" id="u6199_position_content">
        <div class="clearfix colelem" id="u6200-4"><!-- content -->
         <p>Spedizione a:</p>
        </div>
        <div class="clearfix colelem" id="u6202-4"><!-- content -->
         <p><?php echo($riga['name']); ?></p>
        </div>
        <div class="clearfix colelem" id="u6203-4"><!-- content -->
         <p><?php echo($riga['surname']); ?></p>
        </div>
       </div>
      </div>
      <div class="clearfix grpelem" id="pu6201-4"><!-- column -->
       ...
       <div class="clearfix colelem" id="u6204-4"><!-- content -->
        <p><?php echo($riga['address']); ?></p>
       </div>
       <div class="clearfix colelem" id="u6205-4"><!-- content -->
        <p><?php echo($riga['city']); ?></p>
       </div>
      </div>
      <div class="clearfix grpelem" id="pu6206-4"><!-- column -->
       <div class="clearfix colelem" id="u6206-4"><!-- content -->
        <p><?php echo($riga['cap']); ?></p>
       </div>
       <div class="clearfix colelem" id="u6207-4"><!-- content -->
        <p><?php echo($riga['country']); ?></p>
       </div>
      </div>
     </div>
     <div class="rounded-corners clearfix grpelem" id="u6102"><!-- column -->
      <div class="clearfix colelem" id="u6103-4"><!-- content -->
       <p>Totale (<?php echo($ncart);?> prodotti):</p>
      </div>
      <div class="clearfix colelem" id="u6104-4"><!-- content -->
       <p>€ <?php echo(number_format(($subtot), 2, '.', '')); ?></p>
      </div>
      <a href="#" id="order">
      <div class="Button gradient rounded-corners clearfix colelem"   id="buttonu6105"><!-- container box -->
       <div class="clearfix grpelem" id="u6106-4"><!-- content -->
        <p>Ordina</p>
       </div>
      </div>
      </a>
  ...
  <div class="preload_images">
   ...
   <img class="preload" src="images/u6105-r-grad.png" alt=""/>
   <img class="preload" src="images/u6105-grad.png" alt=""/>
   <![endif]-->
  </div>
  <!-- JS includes -->
  <script type="text/javascript">
...
<script type="text/javascript">
		function reset () {
			...
			alertify.confirm("Stai per accettare l'ordine, confermi?", function (e) {
				if (e) {
					window.location='IT-order.php';
				} else {
					alertify.error("Ordine non confermato");
				}
			});
			return false;
		});
