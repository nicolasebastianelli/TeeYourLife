...
<div>
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
     ...
     <ul class="MenuBar clearfix grpelem" id="menuu2506"><!-- horizontal box -->
      <li class="MenuItemContainer clearfix grpelem" id="u2562"><!-- vertical box -->
       ...
       <div class="SubMenu  MenuLevel1 clearfix" id="u2567"><!-- vertical box -->
        ...
        <?php echo"<a href='../product.php?id=".$id."'>"; ?>
    ...
    <form name="myForm2" action="IT-addwish.php" method = "POST" >
    <input type="hidden" name="id" value="<?php echo($id);?>">
    </form>
...
<script type="text/javascript">
		...
		function addmsg(){
		reset();
			alertify.success("Oggetto aggiunto alla lista dei desideri");
			return false;
		}
				function cartmsg(){
		reset();
			alertify.success("Oggetto aggiunto al carrello");
			return false;
		}
		function lerr() {
			reset();
		...
		function errsize() {
			reset();
			alertify.error("Seleziona una taglia");
			return false;
		}
		function readyexist() {
			reset();
			alertify.error("Questa prodotto è già presente nella lista dei desideri");
			return false;
		}
