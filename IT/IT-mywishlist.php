...
<html class="html">
 <head>
  ...
  <title>TYL : LA MIA LISTA DEI DESIDERI</title>
  <!-- CSS -->
...
xmlhttp.open("GET","IT-loadwish.php",true);
xmlhttp.send();
}
</script>
   </head>
 ...
 <script>loadwish()</script>
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class="rgba-background rounded-corners clearfix colelem" id="u6324"><!-- group -->
     <img class="grpelem" id="u6325-5" src="../images/u6325-5.png" alt="My Wishlist" /><!-- rasterized frame -->
    </div>
  ...
  <div class="preload_images">
   <img class="preload" src="../images/u6370-r-grad.png" alt=""/>
   <img class="preload" src="../images/u6370-grad.png" alt=""/>
  </div>
  <![endif]-->
  <!-- JS includes -->
  <script type="text/javascript">
...
<script type="text/javascript">
		...
		function msg(){
		reset();
			alertify.success("Oggetto rimosso dalla lista dei desideri con successo");
			return false;
		}
		</script>
