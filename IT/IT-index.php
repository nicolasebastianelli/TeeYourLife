  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="pmenuu344"><!-- group -->
     <ul class="MenuBar clearfix grpelem" id="menuu344"><!-- horizontal box -->
      <li class="MenuItemContainer clearfix grpelem" id="u1201"><!-- vertical box -->
       <a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive gradient rounded-corners clearfix colelem" id="u1202" href="IT-index.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1204-4"><!-- content --><p>HOME</p></div></a>
      </li>
     ...
     <a class="nonblock nontext MuseLinkActive clip_frame grpelem" id="u674" href="IT-index.php"><!-- image --><img class="block" id="u674_img" src="../images/logo.png" alt="" width="220" height="220"/></a>
    ...
    <div class="rgba-background rounded-corners clearfix colelem" id="u5604"><!-- group -->
     <img class="grpelem" id="u5659-4" src="../images/u5659-4-IT.png" alt="Welcome to TeeYourLife" width="811" height="57" ><!-- rasterized frame -->
    </div>
    <img class="colelem" id="u5672-4" src="../images/u5672-4-IT.png" alt="Try the our new spring&#45;summer collection" width="1018" height="82"><!-- rasterized frame -->
    <div class="clearfix colelem" id="pu5671"><!-- group -->
     <a href="IT-product.php?id=6"><div class="rounded-corners grpelem" id="u5671"><!-- simple frame --></div></a>
     <a href="IT-product.php?id=5"><div class="rounded-corners grpelem" id="u5670"><!-- simple frame --></div></a>
     <a href="IT-product.php?id=1"><div class="rounded-corners grpelem" id="u5660"><!-- simple frame --></div></a>
    </div>
    <div class="clearfix colelem" id="pu5692-4"><!-- group -->
     <div class="clearfix grpelem" id="u5692-4"><!-- content -->
      <p>Spedizione veloce e gratis</p>
     </div>     
     <div class="clearfix grpelem" id="u5700-4"><!-- content -->
      <p>Autunno-Inverno&nbsp;2013</p>
     </div>    
    </div>
    <div class="clearfix colelem" id="pu5685"><!-- group -->
     <div class="rounded-corners grpelem" id="u5685"><!-- simple frame --></div>
    <a href="IT-shop.php?collection=1"> 
...
<script type="text/javascript">
		...
		function login() {
		reset();
			alertify.success("Accesso eseguito");
			return false;
		}
		function logout(){
		reset();
			alertify.success("Disconnessione eseguita");
			return false;
			}
		function signup(){
		reset();
			alertify.success("Registrazione effettuata con successo");
			return false;
		}
				function registererror(){
		reset();
			alertify.error("Sei già registrato");
			return false;
		}
				function lerr(){
		reset();
			alertify.error("Effettuale l'accesso");
			return false;
		}

		function ordmsg(){
		reset();
			alertify.alert("Grazie per aver acquistato i nostri prodotti <3");
			return false;
		}
