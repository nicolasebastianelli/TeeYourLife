<?php
    ...
    else
    {
      ...
      echo " <p>No product in the wishlist</p>";      
      echo "</div>"; 
      mysqli_close($conn);
      }
      else
      ...
      echo"</div>";
      echo"</div>";
      echo"<a href='removewish.php?id_prod=".$id_prod."'>";
      echo" <div class='clearfix grpelem'  id='u6047-4'><!-- content -->";
      echo"  <p id='u6048-3'><span style='font-weight: bold;' id='u6048'><font size='4'>× </font></span><span id='u6048-2'>Remove product from the wishlist</span></p>";
      echo" </div>";
      echo"</a>";
