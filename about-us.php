...
<html class="html">
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="css/about-us.css?385930250" id="pagesheet"/>
 ...
 <body>
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="pmenuu344"><!-- group -->
     <ul class="MenuBar clearfix grpelem" id="menuu344"><!-- horizontal box -->
      ...
      <li class="MenuItemContainer clearfix grpelem" id="u1222"><!-- vertical box -->
       <a class="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive clearfix colelem" id="u1223" href="about-us.php"><!-- horizontal box --><div class="MenuItemLabel NoWrap clearfix grpelem" id="u1225-4"><!-- content --><p>ABOUT US</p></div></a>
      </li>
     </ul>
    ...
    <div class="clearfix colelem" id="pu1175"><!-- group -->
     <div class="rgba-background rounded-corners clearfix grpelem" id="u1175"><!-- group -->
      <img class="grpelem" id="u863-12" src="images/u863-12.png" alt="&nbsp;“
The future belongs to those who believe in the beauty of their dreams. " width="921" height="164"/><!-- rasterized frame -->
     </div>
     <div class="clearfix grpelem" id="u1015-3"><!-- content -->
      <p>&nbsp;</p>
     </div>
    </div>
    <div class="clearfix colelem" id="pu873"><!-- group -->
     <div class="grpelem" id="u873"><!-- custom html -->
      <HR>

</div>
     <div class="grpelem" id="u877"><!-- custom html -->
      <HR>

</div>
    </div>
    <div class="clearfix colelem" id="ppu856-9"><!-- group -->
     <div class="clearfix grpelem" id="pu856-9"><!-- column -->
      <img class="colelem" id="u856-9" src="images/u856-9.png" alt="Who we Are: &quot;Tee your life&quot; born in 2014 by a passion for the tee&#45;shirt and the desire to reinvent the style of everyday. " width="376" height="181"/><!-- rasterized frame -->
      <div class="colelem" id="u875"><!-- custom html -->
       <HR>

</div>
     </div>
     <img class="grpelem" id="u862-9" src="images/u862-9.png" alt="Our Mission: Create a quality product that makes emotions to people who wear our clothes because beauty is never linked to an object in itself, it depends on what you feel about it. " width="377" height="224"/><!-- rasterized frame -->
     <div class="grpelem" id="u879"><!-- custom html -->
      <HR>
